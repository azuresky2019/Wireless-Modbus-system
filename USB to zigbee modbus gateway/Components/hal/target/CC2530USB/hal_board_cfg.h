...
/* 1 - Green 
#define LED1_BV           0//BV(0)        // LJ 避免按键定义使IO口冲突
#define LED1_SBIT         P0_6
#define LED1_DDR          P0_6
#define LED1_POLARITY     ACTIVE_LOW
*/

/* 2 - Red */
#define LED2_BV           0//BV(1)
#define LED2_SBIT         P2_1
#define LED2_DDR          P2_1
...
/* S1 */
#define PUSH1_BV          BV(5)    // LJ 避免按键定义使IO口冲突
...
#define HAL_TURN_OFF_LED2()       (0)
#define HAL_TURN_OFF_LED3()       HAL_TURN_OFF_LED1()
#define HAL_TURN_OFF_LED4()       (0)

#define HAL_TURN_ON_LED1()        st( LED1_SBIT = LED1_POLARITY (1); )
#define HAL_TURN_ON_LED2()        (0)
#define HAL_TURN_ON_LED3()        HAL_TURN_ON_LED1()
#define HAL_TURN_ON_LED4()        (0)

#define HAL_TOGGLE_LED1()         st( if (LED1_SBIT) { LED1_SBIT = 0; } else { LED1_SBIT = 1;} )
#define HAL_TOGGLE_LED2()         (0)
#define HAL_TOGGLE_LED3()         HAL_TOGGLE_LED1()
#define HAL_TOGGLE_LED4()         (0)
